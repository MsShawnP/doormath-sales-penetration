...
def calc_penetration_rate(auth_df, scan_df, quarter, retailers=None,
                          product_lines=None, sku=None, as_of_date=None):
...
def calc_acv_pct(stores_df, auth_df, scan_df, quarter, retailers=None,
                 product_lines=None, sku=None, as_of_date=None):
...
def calc_tdp(stores_df, auth_df, scan_df, quarter, retailers=None,
             product_lines=None, as_of_date=None):
    ...
    total = 0.0
    for sku in skus:
        total += calc_acv_pct(stores_df, auth_df, scan_df, quarter,
                              retailers=retailers, product_lines=product_lines,
                              sku=sku, as_of_date=as_of_date)
    return total
