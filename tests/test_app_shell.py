...
def test_constants_imports():
    ...
    from app.constants import (  # noqa: F401
        CANVAS, CHICAGO_20, HK_35, TEAL_SEQUENTIAL,
        FONT_SERIF, FONT_SANS, DEMO_AS_OF_DATE,
    )
...
def test_layout_has_four_tabs():
    ...
    from app.layout import register_layout, TAB_LABELS
...
def test_default_filter_state():
    ...
    from app.filters import DEFAULT_FILTER_STATE, ALL_RETAILER_IDS, ALL_PRODUCT_LINE_PREFIXES
...
def test_format_helpers():
    ...
    from app.constants import fmt_pct, fmt_delta, fmt_number
