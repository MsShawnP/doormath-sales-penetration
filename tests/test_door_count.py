...
def test_hero_metric_valid_percentage():
    ...
    from app.views.door_count import (
        _filter_data, _compute_penetration, _quarter_to_weeks,
    )
...
def test_retailer_bar_chart_has_correct_groups():
    ...
    from app.views.door_count import (
        _filter_data, _compute_retailer_bars, _quarter_range_weeks,
    )
    from app.filters import DEFAULT_FILTER_STATE
...
def test_product_line_chart_data():
    ...
    from app.views.door_count import (
        _filter_data, _compute_product_line_bars, _quarter_range_weeks,
    )
    from app.filters import DEFAULT_FILTER_STATE
    ...
    # 5 product lines: Artisan Sauces, Pantry Staples, Specialty Condiments, Dried Goods, Snack Bites
...
def test_auth_gap_annotations_are_computed():
    ...
    from app.views.door_count import (
        _filter_data, _compute_auth_gaps, _quarter_to_weeks,
    )
    from app.filters import DEFAULT_FILTER_STATE
