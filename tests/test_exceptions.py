...
class TestComputeExceptions:
    ...
    def test_correct_columns(self):
        ...
        if rows:
            expected_cols = {
                'sku_id', 'item_name', 'product_line', 'retailer_name',
                'store_id', 'region', 'authorized_date', 'last_scan_date',
                'weeks_silent', 'volume_tier',
            }
...
class TestSummaryStats:
    ...
    def test_stats_computed_correctly(self):
        ...
        rows = [
            {'sku_id': 'CHP-AS-001', 'store_id': 'S1', 'retailer_name': 'Walmart',
             'weeks_silent': 10, 'item_name': 'Artisan Sauce #1', 'product_line': 'AS',
             'region': 'West', 'authorized_date': '2024-W01', 'last_scan_date': '2025-W42',
             'volume_tier': 'A'},
            {'sku_id': 'CHP-AS-002', 'store_id': 'S2', 'retailer_name': 'Walmart',
             'weeks_silent': 20, 'item_name': 'Artisan Sauce #2', 'product_line': 'AS',
             'region': 'East', 'authorized_date': '2024-W01', 'last_scan_date': '2025-W32',
             'volume_tier': 'B'},
            {'sku_id': 'CHP-DG-001', 'store_id': 'S3', 'retailer_name': 'Kroger',
             'weeks_silent': 15, 'item_name': 'Dried Good #1', 'product_line': 'DG',
             'region': 'Midwest', 'authorized_date': '2024-W05', 'last_scan_date': '2025-W37',
             'volume_tier': 'A'},
        ]
    ...
    def test_annotation_threshold(self):
        ...
        rows = [
            {'sku_id': f'CHP-AS-{i:03d}', 'store_id': f'S{i}', 'retailer_name': 'R',
             'weeks_silent': 10, 'item_name': f'Item #{i}', 'product_line': 'AS',
             'region': 'W', 'authorized_date': '2024-W01', 'last_scan_date': '2025-W42',
             'volume_tier': 'A'}
            for i in range(1, 12)
        ]
